...
import { CODE_EXAMPLE_BASIC } from '../utils/contstants';
  ...
  return (
    <section>
      <div className='flex items-center justify-between mb-4'>
        <h2 className='text-2xl font-semibold tracking-tight'>Basic Implementation</h2>
        <button
      ...
      {showCode && (
        <div className='mt-4'>
          <CodeBlock code={CODE_EXAMPLE_BASIC} title='Basic Regular Table Example' />
        </div>
      )}
    </section>
  );
