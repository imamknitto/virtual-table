...
import { CODE_EXAMPLE_WITH_FREEZE } from '../utils/contstants';
  ...
  return (
    <section>
      <div className='flex items-center justify-between mb-4'>
        <h2 className='text-2xl font-semibold tracking-tight'>With Freeze Column</h2>
        <button
      ...
      {showCode && (
        <div className='mt-4'>
          <CodeBlock code={CODE_EXAMPLE_WITH_FREEZE} title='Regular Table with Freeze Columns Example' />
        </div>
      )}
    </section>
  );
